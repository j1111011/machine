...
/* ./.libs/lt-exampleProgram.c - temporary wrapper executable for .libs/exampleProgram
   Generated by libtool (GNU libtool) 2.4

   The exampleProgram program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "exampleProgram"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# exampleProgram - temporary wrapper script for .libs/exampleProgram\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4\n", f);
  fputs ("#\n", f);
  fputs ("# The exampleProgram program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"exampleProgram:exampleProgram:${LINENO}: libtool wrapper (GNU libtool) 2.4\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"exampleProgram:exampleProgram:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"exampleProgram:exampleProgram:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
